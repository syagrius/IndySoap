...
type
  ...
  TIdHeaderEncodeEvent = procedure(header : TObject; NamespaceInfo : TIdSoapXmlNamespaceSupport; headerElement : TIdSoapXmlElement) of object;
  ...
  private
    ...
    FProcessed: Boolean;
    FOnEncode: TIdHeaderEncodeEvent;
    procedure CheckOk;
  public
    ...
    property OnEncode : TIdHeaderEncodeEvent read FOnEncode write FOnEncode;
  end;
...
begin
  ...
  Assert(((FContent = nil) and (assigned(OnEncode))) or FContent.TestValid(TIdBaseSoapableClass), ASSERT_LOCATION+': Content is not valid');
end;
